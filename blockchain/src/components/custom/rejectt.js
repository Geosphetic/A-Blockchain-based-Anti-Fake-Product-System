...
class RejectProduct extends Component{
    ...
    addProductToBlockchain = () => {
        ...
        this.state.product.methods
            .rejectProduct(this.state.product_name, this.state.product_details, this.state.id)
        ...
        return(
            <div className="container">
                <form onSubmit={this.handleSubmit}>
                    ...
                    <input type="text" id="rejectReason" name="rejectReason" onChange={this.handleInputChange} required/>
