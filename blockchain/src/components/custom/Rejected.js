            ...
            return (
                <div className="contact" key={products.id}>
                    ...
                    <i class="material-icons">&#xe854;</i>
                        ...
                        <p className="secondary-content"><b>REJECTED.! Try Another Prototype.!</b></p>
                    </li>
                </div>
            )
        }) 
        return(
            <div className="container">
                <ul className="collection">
                    <li className="collection-item avatar">
                        <p className="title"><b>Rejected Information</b></p>
                        <p className="secondary-content"><p><br></br>This prototype is Rejected. Please make another prototype, or else you may send a NO information..!</p></p>
                    </li>
                        {productList}
                </ul>
            </div>
